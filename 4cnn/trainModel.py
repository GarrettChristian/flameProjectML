...
def main():
    ...
    train_data, test_data, _, _ = train_test_split(
        files, labelsSplit, test_size=0.3, random_state=21, stratify=labelsSplit
    )
    ...
    history = model.fit(training_generator, validation_data=validation_generator, epochs=30, use_multiprocessing=True)
